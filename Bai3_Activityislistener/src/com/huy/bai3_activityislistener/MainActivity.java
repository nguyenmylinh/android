package com.huy.bai3_activityislistener;
...
editTen=(EditText) findViewById(R.id.txtTen);
editChieucao=(EditText) findViewById(R.id.txtcc);
editCannang=(EditText) findViewById(R.id.txtKg);
editBMI=(EditText) findViewById(R.id.txtcsbmi);
editChandoan=(EditText) findViewById(R.id.txtcd);
}
@Override
